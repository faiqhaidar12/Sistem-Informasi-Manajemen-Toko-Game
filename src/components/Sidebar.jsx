...
const Sidebar = () => {
  return (
    <div>
      <div className="lg:hidden md:hidden text-justify  h-auto relative overflow-x-auto shadow-md rounded-lg m-5">
        <ul className="flex flex-row text-sm font-medium text-gray-900  rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
          <NavLink
            to={"/dashboard"}
